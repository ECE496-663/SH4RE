...
struct CreateListingView: View {
    ...
    func post() {
        ...
        getUserName(uid: getCurrentUserUid(), completion: { name in
            let listingFields = ["Title": title, "Description" : description, "Price" : cost, "Category" : categorySelection, "Availability": calAvail, "_geoloc": ["lat": lat, "lon": lon], "UID": getCurrentUserUid(), "ownerName":name, "sponsored":0, "timestamp": Timestamp(date:Date())] as [String : Any]
