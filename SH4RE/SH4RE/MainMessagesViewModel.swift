            ...
            .addSnapshotListener { querySnapshot, error in
                ...
                querySnapshot?.documentChanges.forEach({ change in
                    ...
                    do {
                        ...
                        let rm = RecentMessage(id: docId, text: text, name:name, fromId: fromId, toId: toId, timestamp: timestamp, isRequest: isRequest, listingTitle: listingTitle, datesRequested:datesRequested, listingId: listingId, requestId: requestId, isReviewRequest: isReviewRequest)
